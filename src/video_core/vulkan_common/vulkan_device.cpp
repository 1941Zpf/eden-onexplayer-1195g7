...
Device::Device(VkInstance instance_, vk::PhysicalDevice physical_, VkSurfaceKHR surface,
    ...
    const VmaAllocatorCreateInfo allocator_info{
            ...
            .device = *logical,
            // OneXPlayer 1S / Iris Xe target: use larger integrated-GPU VMA blocks to reduce
            // allocation churn and heap fragmentation during open-world texture streaming.
