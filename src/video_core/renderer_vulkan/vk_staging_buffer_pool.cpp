...
constexpr VkDeviceSize DEFAULT_MAX_STREAM_BUFFER_SIZE = 128_MiB;

size_t GetStreamBufferSize(const Device& device) {
    VkDeviceSize size{0};
    const VkDeviceSize max_stream_buffer_size =
        Core::GameSettings::GetVulkanUploadStreamBufferSize(DEFAULT_MAX_STREAM_BUFFER_SIZE);
